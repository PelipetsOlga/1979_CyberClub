...
object NetworkModule {
    ...
    fun provideRetrofit(
        ...
        // Base URL will be constructed from BuildConfig.DOMAIN
        // For now using placeholder - should be injected via BuildConfig
        val baseUrl = "https://api.example.com/api/v1/"
